-- ----------------------------
--  Table structure for CustomerPromotionPrice related to issue: DMC-71157
-- ----------------------------
DROP TABLE IF EXISTS "main"."CustomerPromotionPrice";
CREATE TABLE "CustomerPromotionPrice" (
