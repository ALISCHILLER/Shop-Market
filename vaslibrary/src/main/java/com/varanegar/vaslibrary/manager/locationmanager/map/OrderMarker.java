...
public class OrderMarker extends TrackingMarker<OrderLocationViewModel> {

    public OrderMarker(@NonNull Activity activity, OrderLocationViewModel locationModel) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater) {
        ...
        iconImageView.setImageResource(R.drawable.order);
        OrderLocationViewModel orderLocationViewModel = getLocationViewModel();
        TextView timeTextView = view.findViewById(R.id.time_text_view);
        timeTextView.setText(DateHelper.toString(orderLocationViewModel.ActivityDate, DateFormat.Complete, Locale.getDefault()));
        return view;
    }
