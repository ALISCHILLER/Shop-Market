...
import com.varanegar.vaslibrary.ui.dialog.NonDeliverAllUnknownCustomersDialog;
...
public abstract class SendTourFragment extends PopupFragment {
    ...
    public void onViewCreated(@NonNull final View view,
        ...
        simpleToolbar.setOnBackClickListener(view1 -> back());

        statusTextView = view.findViewById(R.id.status_text_view);
        statusTextView.setMovementMethod(new ScrollingMovementMethod());
        view.findViewById(R.id.send_tour).setOnClickListener(view12 -> {
            Timber.d("Send tour clicked");
            tryToSendTour();
        });

        view.findViewById(R.id.cancel_tour).setOnClickListener(view13 -> {
            ...
            if (isSending) {
                ...
                dialog.setPositiveButton(R.string.yes, view131 -> {
                    ...
                    if (activity != null && !activity.isFinishing() && isResumed()) {
                        activity.runOnUiThread(() -> {
                            if (!VaranegarApplication.is(VaranegarApplication.AppId.Dist)) {
                                ((PairedItems) view.findViewById(R.id.tour_no_paired_items))
                                        .setValue(String.valueOf(tourInfo.TourNo));
                                ((PairedItems) view.findViewById(
                                        R.id.today_customers_count_paired_items))
                                        .setValue(String.valueOf(tourInfo.DayCustomersCount));
                                ((PairedItems) view.findViewById(
                                        R.id.today_visited_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.DayVisitedCount));
                                ((PairedItems) view.findViewById(
                                        R.id.today_ordered_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.DayOrderedCount));
                                ((PairedItems) view.findViewById(
                                        R.id.today_lack_of_order_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.DayLackOfOrderCount));
                                ((PairedItems) view.findViewById(
                                        R.id.lack_of_visit_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.DayLackOfVisitCount));
                                ((PairedItems) view.findViewById(
                                        R.id.today_sum_of_ordered_paired_items))
                                        .setValue(HelperMethods
                                                .currencyToString(tourInfo.DayOrderSum));

                                ((PairedItems) view.findViewById(
                                        R.id.total_customers_count_paired_items))
                                        .setValue(String.valueOf(tourInfo.TotalCustomersCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_visited_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.TotalVisitedCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_ordered_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.TotalOrderedCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_lack_of_order_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.TotalLackOfOrderCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_sum_of_ordered_paired_items))
                                        .setValue(HelperMethods
                                                .currencyToString(tourInfo.TotalOrderSum));

                                view.findViewById(
                                        R.id.total_deliveries_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(
                                        R.id.total_partial_deliveries_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(
                                        R.id.total_lack_of_deliveries_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(
                                        R.id.total_lack_of_visits_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(
                                        R.id.total_return_customer_paired_items)
                                        .setVisibility(View.GONE);

                                ((PairedItems) view.findViewById(
                                        R.id.total_visit_time_paired_items))
                                        .setValue(tourInfo.VisitTime);
                                ((PairedItems) view.findViewById(
                                        R.id.tour_time_paired_items))
                                        .setValue(tourInfo.TourTime);

                                ProductOrderViewManager productOrderViewManager =
                                        new ProductOrderViewManager(getContext());
                                boolean spd = productOrderViewManager.getSPD();
                                if (spd)
                                    ((PairedItems) view.findViewById(R.id.spd_paired_items))
                                ...
                                ((PairedItems) view.findViewById(
                                        R.id.visit_to_customer_paired_items))
                                        .setValue(df.format(tourInfo.DayVisitRatio) + " %");
                            } else {
                                ((PairedItems) view.findViewById(R.id.tour_no_paired_items))
                                        .setValue(String.valueOf(tourInfo.TourNo));
                                view.findViewById(R.id.today_customers_count_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.today_visited_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.today_ordered_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.today_lack_of_order_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.lack_of_visit_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.today_sum_of_ordered_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.total_ordered_customer_paired_items)
                                        .setVisibility(View.GONE);
                                view.findViewById(R.id.total_lack_of_order_customer_paired_items)
                                        .setVisibility(View.GONE);
                                ...
                                ((PairedItems) view.findViewById(
                                        R.id.total_deliveries_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.DeliveriesCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_partial_deliveries_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.PartialDeliveriesCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_lack_of_deliveries_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.LackOfDeliveriesCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_lack_of_visits_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.TotalLackOfVisitCount));
                                ((PairedItems) view.findViewById(
                                        R.id.total_return_customer_paired_items))
                                        .setValue(String.valueOf(tourInfo.ReturnsCount));
                                ...
                                view.findViewById(R.id.spd_paired_items).setVisibility(View.GONE);
                                view.findViewById(R.id.visit_to_customer_paired_items)
                                        .setVisibility(View.GONE);
                            }
                        });
                    }
        ...
        SysConfigModel serverAddressConfig = sysConfigManager.read(ConfigKey.ValidServerAddress,
        ...
        SysConfigModel localServerAddressConfig =
                sysConfigManager.read(ConfigKey.LocalServerAddress,
                        SysConfigManager.local);
        if (localServerAddressConfig != null)
            ((TextView) view.findViewById(R.id.local_ip_text_view))
                    .setText(localServerAddressConfig.Value);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ...
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.send_tour_layout_fragment,
                container, false);
    }
            ...
            if (tourManager.isSendServiceConnected())
                ...
                tourManager.getTourStatus(new TourManager.ITourStatusCallback() {
                    ...
                    public void onStatus(UUID status) {
                        if (status.equals(TourStatus.Sent) ||
                                status.equals(TourStatus.InProgress)) {
                            try {
                    ...
                    public void onFailure() {
                        ...
                        dialog.setIcon(Icon.Error);
                        dialog.setMessage(
                                R.string.sending_tour_is_interrupted_please_contact_administrator);
                        dialog.setPositiveButton(R.string.ok, null);
                        dialog.show();
                    }
                });
    ...
    private void clearStatus() {
        MainVaranegarActivity activity = getVaranegarActvity();
        if (activity != null)
            activity.getSharedPreferences("TOUR_STATUS_LIST",
    ...
    private void readStatus() {
        ...
        if (activity != null) {
            SharedPreferences sp = activity
                    .getSharedPreferences("TOUR_STATUS_LIST",
                            Context.MODE_PRIVATE);
            Map<String, ?> allStatus = sp.getAll();
            int last = 0;
            for (String key : allStatus.keySet()) {
    ...
    private void initSendTour() {
        ...
        if (customerPathViewManager.hasIncompleteOperation() &&
            ...
            if (!Connectivity.isConnected(activity)) {
                ...
                connectionSettingDialog
                        .show(activity.getSupportFragmentManager(), "ConnectionSettingDialog");
                isSending = false;
                return;
            }
    ...
    private void showDeleteTourConfirm(String tourStatus) {
        ...
        confirmDialog.setPositiveButton(R.string.yes_i_take_responsibility, v -> {
            ...
            confirmDialog1.setMessage(getContext().getString(R.string.are_you_sure) + "\n" +
    ...
    private void showSendTourConfirm() {
        ...
        confirmDialog.setPositiveButton(R.string.yes, v -> {
            ...
            if (customerPathViewManager.isAllCustomersOfPathVisited()) {
                ...
                dialog.setPositiveButton(R.string.ok, null);
               if (!VaranegarApplication.is(VaranegarApplication.AppId.Dist)) {
                    dialog.setNegativeButton(R.string.non_visit_all_customers, view -> {
                        NonVisitAllUnknownCustomersDialog nonVisitAllUnknownCustomersDialog =
                                new NonVisitAllUnknownCustomersDialog();
                        nonVisitAllUnknownCustomersDialog.onVisitStatusChanged = () -> {
                            dialog.dismiss();
                            addStatus(R.string.populating_and_send_tour);
                            populateAndSendData();
                        };
                        if (getActivity() != null) {
                            nonVisitAllUnknownCustomersDialog
                                    .show(getActivity()
                                                    .getSupportFragmentManager(),
                                            "NonVisitActionDialog");
                        }
                    });
                }else {
                   dialog.setNegativeButton(R.string.non_deliver_all, view -> {
                       NonDeliverAllUnknownCustomersDialog nonDeliverAllUnknownCustomersDialog =
                               new NonDeliverAllUnknownCustomersDialog();
                       nonDeliverAllUnknownCustomersDialog.onDeliverStatusChanged = () -> {
                           dialog.dismiss();
                           addStatus(R.string.populating_and_send_tour);
                           populateAndSendData();
                       };
                       if (getActivity() != null) {
                           nonDeliverAllUnknownCustomersDialog
                                   .show(getActivity()
                                                   .getSupportFragmentManager(),
                                           "NonDeliversActionDialog");
                       }
                   });
               }
    ...
    private void populateAndSendData() {
        ...
        if (!Connectivity.isConnected(activity)) {
            ConnectionSettingDialog connectionSettingDialog =
                    new ConnectionSettingDialog();
            connectionSettingDialog.show(activity
                            .getSupportFragmentManager(),
                    "ConnectionSettingDialog");
            isSending = false;
            return;
        ...
        if (VaranegarApplication.is(VaranegarApplication.AppId.HotSales)) {
            HotSalesOnHandQtyApi hotSalesOnHandQtyApi =
                    new HotSalesOnHandQtyApi(getContext());
            ...
            if (userModel == null ||
                    ...
                    tourModel == null ||
                    tourModel.UniqueId == null)
                return;
            call = hotSalesOnHandQtyApi.renew(
                    userModel.UniqueId.toString(),
                    tourModel.UniqueId.toString());
            hotSalesOnHandQtyApi.runWebRequest(call,
                    new WebCallBack<List<OnHandQtyModel>>() {
                        @Override
                        ...
                        protected void onSuccess(List<OnHandQtyModel> result, Request request) {
                            ...
                            List<OnHandQtyModel> oldOnHandQtyModels =
                                    onHandQtyManager.getItems(new Query()
                                            .from(OnHandQty.OnHandQtyTbl));
                            HashMap<UUID, BigDecimal> oldOnHandQty = new HashMap<>();
                            for (OnHandQtyModel onHandQtyModel :
                                    oldOnHandQtyModels) {
                                oldOnHandQty.put(onHandQtyModel.ProductId,
                                        onHandQtyModel.OnHandQty.stripTrailingZeros());
                            }
                            HashMap<UUID, BigDecimal> newOnHandQty = new HashMap<>();
                            for (OnHandQtyModel onHandQtyModel : result) {
                                newOnHandQty.put(onHandQtyModel.ProductId,
                                        onHandQtyModel.OnHandQty.stripTrailingZeros());
                            }
            ...
            tourManager.verifyData(new TourManager.VerifyCallBack() {
                ...
                public void onSuccess(final List<UUID> result) {
                    ...
                    if (result != null && result.size() > 0 && getContext() != null) {
                        isSending = false;
                        CuteMessageDialog dialog = new CuteMessageDialog(getContext());
                        dialog.setTitle(R.string.some_customer_data_is_not_saved);
                        addStatus(R.string.some_customer_data_is_not_saved);
                        ...
                        List<CustomerModel> customerModels =
                                customerManager.getCustomers(result);
                        StringBuilder msg = new StringBuilder(getString(R
                                .string.do_you_want_to_restore_these_customers));
                        for (CustomerModel customerModel :
                                customerModels) {
                            msg.append(System.getProperty("line.separator"))
                                    .append(customerModel.CustomerName);
                        ...
                        dialog.setPositiveButton(R.string.yes, view -> {
                            ...
                            for (UUID customerId :
                                    result) {
                                try {
                                    customerCallManager.removeCall(
                                            CustomerCallType.SendData,
                                            customerId);
                                } catch (DbException e) {
                                    Timber.e(e);
                        ...
                        tourManager.sendTour(new TourManager.TourCallBack() {
                            ...
                            public void onSuccess() {
                                ...
                                if (activity != null && !activity.isFinishing()) {
                                    ...
                                    dialog.setMessage(activity.getString(R.string.tour_sent));
                                    dialog.setIcon(Icon.Success);
                                    dialog.setPositiveButton(R.string.ok, view -> back());
                                    dialog.show();
                                }
                            }
