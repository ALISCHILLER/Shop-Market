...
public class CustomerNoSaleReportAdapter extends SimpleReportAdapter<CustomerModel> {
    public CustomerNoSaleReportAdapter(MainVaranegarActivity activity) {
        super(activity, CustomerModel.class);
    }

    public CustomerNoSaleReportAdapter(VaranegarFragment fragment) {
        super(fragment, CustomerModel.class);
    }
