...
public class Ml_dialog3 extends CuteDialogWithToolbar {
    private View view;
    ...
    public void setValues(List<CustomerGroupSimilarProductsalesReportModel> ProductModel,String customerName) {
    ...
    public View onCreateDialogView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.layout_ml_dialog3, container, false);
        TextView okTv = view.findViewById(R.id.ok_text_view);
        TextView txt_title = view.findViewById(R.id.txt_title);
        txt_title.setText("کالا های خریداری شده مشتریان مشابه "+" "+"تعداد کالا:"+productModel.size());
        ...
        adapter = new BaseRecyclerAdapter<CustomerGroupSimilarProductsalesReportModel>(getVaranegarActvity(), productModel) {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.center_owners_row,
                        parent, false);
                return new Ml_dialog3.CenterSysConfigViewHolder(itemView, adapter, getContext());
            }
        };
