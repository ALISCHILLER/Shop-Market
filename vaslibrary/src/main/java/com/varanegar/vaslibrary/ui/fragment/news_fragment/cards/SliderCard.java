package com.varanegar.vaslibrary.ui.fragment.news_fragment.cards;
...
import com.varanegar.vaslibrary.ui.fragment.news_fragment.cards.utils.DecodeBitmapTask;
...
public class SliderCard extends RecyclerView.ViewHolder implements DecodeBitmapTask.Listener {
    ...
    private void loadBitmap(@DrawableRes int resId) {
        task = new DecodeBitmapTask(itemView.getResources(),
                resId, viewWidth, viewHeight, this);
        task.execute();
    }
