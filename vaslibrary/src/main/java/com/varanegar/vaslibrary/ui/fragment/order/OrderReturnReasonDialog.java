...
public class OrderReturnReasonDialog extends CuteAlertDialog {
    ...
    protected void onCreateContentView(LayoutInflater inflater, ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        setTitle(R.string.please_select_a_reason);
        ...
        final List<NoSaleReasonModel> noSalesReasons = manager.getDistOrderReturnReason();
    ...
    public void ok() {
        ...
        if (noSaleReasonModel == null) {
            Toast.makeText(getContext(), R.string.please_select_a_reason, Toast.LENGTH_SHORT).show();
            return;
        }
        getDialog().dismiss();
