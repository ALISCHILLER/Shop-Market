...
public class PromotionDoEVCBySpecialValueV3 {
    ...
    public static void doEVCBySpecialValue(String evcId) {
        ...
        updateAdd1(evcId);
        updateAdd2(evcId);
        EVCItemSDSDBAdapter.getInstance().updateAddDiscountWithSpecialValues(evcId);
        updateNetAmountWithSpecialValues(evcId);
        EVCHeaderSDSDBAdapter.getInstance().updateAddDisWithSpecialValues(evcId);
    }
