...
public class PromotionFillStatuteByIdSDSV3 {
    ...
    public static void fillStatuteById(String evcId, int orderId, String orderDate, String orderTypeId, int saleId, int orderNo) throws DiscountException {
        ...
        while (evcItemStatutesExists == 1 && counter<100){
    ...
    private static void extractValidDiscount(String evcId, int ordeId, String orderDate, String orderTypeId, int saleId, int evcType, int orderNo) {

        EVCTempSDSDBAdapter.getInstance().fillEVCTemp(evcId, ordeId, orderDate, orderTypeId, saleId, evcType, orderNo);
    }
