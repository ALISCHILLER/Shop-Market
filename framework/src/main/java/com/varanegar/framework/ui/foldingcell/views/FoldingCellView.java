package com.varanegar.framework.ui.foldingcell.views;
 ...
 *
 * Basic element for folding animation that represents one physic part of folding
 * sheet with different views on front and back.
 *
 */
